    ...
    <?php }?>
        ...
        <div class="checkout_offset">
            ...
            <div class="checkout_price" id="cart_total_info">
                <ul>
                    <li class="shopping_cart_04_03"><span id="true_price" style="display: none" class="bbb"><span id="coin"><?php echo $_SESSION['currency'];?> 0.00</span></span>
	    <span class="bbb" id="all_money" style="display:block;"><?php echo $_SESSION['currency'];?>&nbsp;<?php echo
...
<script type="text/javascript">
    ...
    $('.checkbox-id').bind("change",function(){
        ...
        var oAllPriceInfo  = oAllPrice.replace('<?php echo $_SESSION['currency'];?>','');
        ...
        $.ajax({
            ...
            success: function(msg){
                $('#coin').text(msg);
                if(msg=="<?php echo $_SESSION['currency'];?> 0.00"){
                    $('#all_money').show();
                    $('#true_price').hide();
                }else{
                    $('#all_money').hide();
    ...
    $("#checkbox_pro").click(function(){
        if($(this).is(':checked')){
            ...
            $('input[name="products[]"]').each(function(){
                ...
                $('#coin').text("<?php echo $_SESSION['currency'];?> "+0.00);
            });
        }
        if($(this).is(':checked')){
            var status='1';
