    ...
    if ($content_of_reviews) {
        ...
        foreach ($page_reviews as $ii => $review) {
            ...
            if ($is_true_customer != null && $is_true_customer == $_SESSION['customer_id']) {
                ...
                $str .= '<img src=' . $img_src . ' alt="Replace Head" width="48" height="48" border="0">
                <div class="portrait_pic_p".$img_class><img src="images/portrait_pic_p.png" alt="Replace Head" width="32" height="32" border="0">
                ...
                $str .= '<img src=' . $img_src . '  ; " alt="  $img_src; " width="48" height="48" border="0">';
            }
            if ($is_true_customer != null) {
                $name = $final_name;
            } else {
            ...
            */
            ...
            if (sizeof($products_review_img)) {
                ...
                for ($rpi = 0; $rpi < sizeof($products_review_img); $rpi++) {
                    ...
                    $str .= '<li><a href="javascript:void($(\'#fs_overlays_reviews,#basic-modal-content_reviews_' . $review['rid'] . $rpi . '\').show())">' . $image . '</a></li>';
                }
                $str.= '</ul></div>';
            }
        ...
        if (sizeof($products_review_img)) {
            ...
            for ($rpii = 0; $rpii < sizeof($products_review_img); $rpii++) {
               ...
               $str .= '<div id="basic-modal-content_reviews_' . $review['rid'] . $rpii . '" class="ui-widget ui-widget-content ui-corner-all ui-corner_pop_large" style="display: none;">
		...
		<div class="reviews_close"><a href="javascript:;" onclick="$(\'#fs_overlays_reviews,#basic-modal-content_reviews_' . $review['rid'] . $rpii . '\').hide();"></a></div></div>';
            ...
            if (isset($fssays) && $fssays) {
                foreach ($fssays as $key => $says) {
                    ...
                    $str .= '<div class="P_06_reply_icon"><img src="' . $finalsrc . '" alt="' . $finalsrc . '" width="28" height="28" border="0"></div>
