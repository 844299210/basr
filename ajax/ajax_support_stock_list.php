...
if(isset($_GET['request_type'])){
	...
	switch($_GET['request_type']){
		case 'getNextCate':
			...
			if (cacheFactory::get_cached_file_contents(DIR_FS_CATALOG.'cache/stocklist/'.$fileName, $html)) {
				echo $html;
				exit;
			}
			...
			//$fileName = $a_id.'_'.$group_id.'_'.$first_id.'.html';
			cacheFactory::save_caching_file_contents(DIR_WS_CATALOG.'cache/stocklist/'.$fileName, DIR_FS_CATALOG.'cache/stocklist/'.$fileName, $html);
			echo $html;
		break;
    }
}