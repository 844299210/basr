...
if (zen_not_null($action)) {
		...
		switch ($action){
			...
			case 'categories_page_link':
				...
				$zen_SiteMapXML->build_categories_page_link_sitemap();
				break;
			case 'products':
			...
			case 'news':
				...
				break;
			case 'reviews':	
			    $zen_SiteMapXML->build_reviews_sitemap();			
				break;
			case 'producttags':		
			...
			case 'one_key_generate':
				...
				//$zen_SiteMapXML->build_producttags_sitemap();
				$zen_SiteMapXML->build_articlepage_sitemap();
				$zen_SiteMapXML->build_popular_list_sitemap();
				$zen_SiteMapXML->build_popular_keyword_sitemap();
				$zen_SiteMapXML->build_Narrow_by_sitemap();

				$zen_SiteMapXML->build_other_Narrow_by_sitemap();
