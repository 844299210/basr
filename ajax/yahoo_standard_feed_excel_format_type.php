...
$objPHPExcel->getActiveSheet ()->setTitle ( 'yahoo standard' );
...
$exel_columns = array ('A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L','M' );
$pricegrabber_title =
array ('Unique-Retailer-SKU', 'Manufacturer-Part-Number', 'Condition', 'Availability', 'Selling-Price', 'Manufacturer-Name', 'Product-Title', 'Categorization', 'Product-URL', 'Image-URL', 'Detailed-Description', 'Weight','UPC' );
...
//						zen_yahoo_fwrite($output);
			...
			$objWriter->save ( DIR_FS_CATALOG . 'feed/yahoo_standard_datafeed_excel_format.xls');
	//zen_yahoo_fwrite();
