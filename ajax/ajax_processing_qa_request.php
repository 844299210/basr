...
if(isset($_GET['request_type'])){
	...
	require 'includes/application_top.php';
		switch ($_GET['request_type']){
		    ...
		    $products_name = mysql_real_escape_string($_POST['products_name']);
			$operate_name = mysql_real_escape_string($_POST['admin_name']);
			$question = mysql_real_escape_string($_POST['qa_question']);
			$answer = mysql_real_escape_string($_POST['qa_answer']);
